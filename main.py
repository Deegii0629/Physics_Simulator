...
# P2 is the center point while p1 is the other point that creates an angle
# This function measures the angle and returns it in radians
...
def create_boundaries(space, width, height):
    ...
    for pos, size in rects:
        # We have to make the boundaries static or else the gravity will take effect
...
def create_structure(space, width, height):
    ...
    rects = [
        ...
        [(750, height - 10), (340,40), BROWN, 150]
    ]
...
def create_pendulum(space):
     # Y of rotation_center_body has to be different from the body position Y
     # So that the line and the surface don't overlap
